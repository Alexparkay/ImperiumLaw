...
// Mock data for acquisition targets
const acquisitionTargets = [
  {
    ...
    growth: 28.5,
    founded: 2017,
    description: 'Provider of cloud-based workflow automation solutions for small to medium businesses.',
    matchScore: 92,
    watch: true,
    status: 'Contacted',
...
const AcquisitionTargetsPage = () => {
  ...
  const targetData = selectedTarget 
    ? acquisitionTargets.find(target => target.id === selectedTarget) 
    : null;
    ...
    <div className="h-full">
      ...
      <div className="min-h-screen bg-white text-gray-800 p-6">
        ...
        <motion.div 
          ...
          className="mb-8"
        >
          <h1 className="text-3xl font-semibold mb-2 text-gray-800">Acquisition Targets</h1>
          <p className="text-gray-600">
            Explore and evaluate potential acquisition targets matched to your criteria.
          </p>
        </motion.div>
        ...
        >
          ...
          {selectedTarget && targetData && (
            ...
            >
              ...
              {/* Company info */}
              <div className="mb-6">
                <h3 className="text-lg font-medium text-gray-800 mb-3">Company Overview</h3>
...
export default AcquisitionTargetsPage; 