...
import { HiBars3CenterLeft, HiOutlineCircleStack } from 'react-icons/hi2';
        ...
        <div className="drawer w-auto p-0 mr-1 xl:hidden">
          ...
          <div className="drawer-side z-[99]">
            ...
            <div className="menu p-4 w-auto min-h-full bg-base-200 text-base-content">
              ...
              >
                <HiOutlineCircleStack className="text-3xl sm:text-4xl xl:text-4xl 2xl:text-6xl text-primary" />
